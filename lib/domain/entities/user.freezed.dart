...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, subscriptionType: $subscriptionType, lastLoginDate: $lastLoginDate)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, email, name, subscriptionType, lastLoginDate);
...
abstract class _User implements User {
  const factory _User(
      ...
      final String subscriptionType,
      final DateTime? lastLoginDate}) = _$UserImpl;
